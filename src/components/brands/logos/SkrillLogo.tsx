...
const SvgSkrillLogo = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <defs>
      ...
      >
        <stop stopColor="#6B195F" />
        <stop offset={1} stopColor="#4C255B" />
      </linearGradient>
    </defs>
  </svg>
);

export default SvgSkrillLogo;
