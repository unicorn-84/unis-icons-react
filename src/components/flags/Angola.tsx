        ...
        <g mask="url(#angola_svg__c)">
          ...
          <g mask="url(#angola_svg__d)">
            ...
            >
              <path
                fill="#FCFF01"
                d="m14.077 11.464-1.068.658.377-1.102-1.037-.695 1.3-.024.428-1.087.427 1.087 1.301.024-1.037.695.377 1.102-1.068-.658Z"
              />
              <path
                fill="#FFEA42"
                d="m14.077 11.464-1.068.658.377-1.102-1.037-.695 1.3-.024.428-1.087.427 1.087 1.301.024-1.037.695.377 1.102-1.068-.658Z"
            ...
            >
              <path
                fill="#FCFF01"
                d="M11.566 11.86s-1.895 2.468-.403 3.37c1.492.903 9.38 4.708 9.38 4.708s1.63-.009 1.861.3c.232.308.714.67.918.67.203 0 .728-.326.728-.326s.41-.298 0-.644c-.41-.347-2.573-1.532-2.573-1.532s-8.447-4.792-9.165-5.266c-.718-.474-.746-1.28-.746-1.28Z"
              />
              <path
                fill="#FFEA42"
                d="M11.566 11.86s-1.895 2.468-.403 3.37c1.492.903 9.38 4.708 9.38 4.708s1.63-.009 1.861.3c.232.308.714.67.918.67.203 0 .728-.326.728-.326s.41-.298 0-.644c-.41-.347-2.573-1.532-2.573-1.532s-8.447-4.792-9.165-5.266c-.718-.474-.746-1.28-.746-1.28Z"
    ...
    <defs>
      ...
      >
        ...
        <feBlend
          ...
          result="effect1_dropShadow_91_29847"
        />
        <feColorMatrix
          in="SourceAlpha"
          result="hardAlpha"
        ...
        <feBlend
          in2="effect1_dropShadow_91_29847"
          result="effect2_dropShadow_91_29847"
        />
        <feBlend
          in="SourceGraphic"
