...
const SvgBosniaAndHerzegovina = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#bosnia-and-herzegovina_svg__a)">
      <g clipPath="url(#bosnia-and-herzegovina_svg__b)">
        <mask
          id="bosnia-and-herzegovina_svg__c"
          width={36}
          height={24}
          x={3}
          y={2}
        ...
        <g
          fillRule="evenodd"
          clipRule="evenodd"
          mask="url(#bosnia-and-herzegovina_svg__c)"
        >
    ...
    <defs>
      <clipPath id="bosnia-and-herzegovina_svg__b">
        <rect width={36} height={24} x={3} y={2} fill="#fff" rx={2} />
      </clipPath>
      <filter
        id="bosnia-and-herzegovina_svg__a"
        width={42}
        height={30}
        x={0}
        y={0}
