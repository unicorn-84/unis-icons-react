...
const SvgFaroeIslands = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#faroe-islands_svg__a)">
      <g clipPath="url(#faroe-islands_svg__b)">
        <mask
          id="faroe-islands_svg__c"
          width={36}
          height={24}
          x={3}
          y={2}
        ...
        <g mask="url(#faroe-islands_svg__c)">
          <path
            fill="#F7FCFF"
            fillRule="evenodd"
            d="M3 2v24h36V2H3Z"
          ...
          <g mask="url(#faroe-islands_svg__d)">
            <path
              fill="#F50100"
              stroke="#2E42A5"
              strokeWidth={2}
    ...
    <defs>
      <clipPath id="faroe-islands_svg__b">
