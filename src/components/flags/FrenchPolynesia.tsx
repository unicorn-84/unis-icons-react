...
const SvgFrenchPolynesia = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#french-polynesia_svg__a)">
      <g clipPath="url(#french-polynesia_svg__b)">
        <mask
          id="french-polynesia_svg__c"
          width={36}
          height={24}
          x={3}
          y={2}
        ...
        <g mask="url(#french-polynesia_svg__c)">
          <path
            fill="#F7FCFF"
            fillRule="evenodd"
            d="M3 2v24h36V2H3Z"
          ...
          <g mask="url(#french-polynesia_svg__d)">
            <path
              fill="#BF2714"
              fillRule="evenodd"
              d="M3 2v6h36V2H3Zm0 18v6h36v-6H3Z"
              clipRule="evenodd"
            />
            <mask
              id="french-polynesia_svg__e"
              width={14}
              height={12}
              x={14}
              y={8}
    ...
    <defs>
      <clipPath id="french-polynesia_svg__b">
      ...
      >
        ...
        <feBlend
          ...
          result="effect1_dropShadow_91_25916"
        />
        <feColorMatrix
          in="SourceAlpha"
          result="hardAlpha"
        ...
        <feBlend
          in2="effect1_dropShadow_91_25916"
          result="effect2_dropShadow_91_25916"
        />
        <feBlend
          in="SourceGraphic"
          in2="effect2_dropShadow_91_25916"
          result="shape"
        />
      </filter>
    </defs>
