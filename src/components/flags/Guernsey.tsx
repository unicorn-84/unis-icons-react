...
const SvgGuernsey = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#guernsey_svg__a)">
      <g clipPath="url(#guernsey_svg__b)">
        <mask
          id="guernsey_svg__c"
          width={36}
          height={24}
        ...
        <g mask="url(#guernsey_svg__c)">
          ...
          <g fillRule="evenodd" clipRule="evenodd" mask="url(#guernsey_svg__d)">
            <path
              fill="#E31D1C"
