...
const SvgKenia = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#kenia_svg__a)">
      <g clipPath="url(#kenia_svg__b)">
        <mask
          id="kenia_svg__c"
          width={36}
          height={24}
