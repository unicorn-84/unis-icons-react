...
const SvgLiechtenstein = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#liechtenstein_svg__a)">
      <g clipPath="url(#liechtenstein_svg__b)">
        <mask
          id="liechtenstein_svg__c"
          width={36}
          height={24}
          x={3}
          y={2}
        ...
        <g mask="url(#liechtenstein_svg__c)">
          <path
            fill="#E31D1C"
            fillRule="evenodd"
            d="M3 2v24h36V2H3Z"
          ...
          <g mask="url(#liechtenstein_svg__d)">
            <path
              fill="#2E42A5"
              fillRule="evenodd"
              d="M3 2v12h36V2H3Z"
            ...
            <path
              fill="#000"
              fillRule="evenodd"
              d="M8.398 13.053s1.357.751 4.503.751 4.816-.751 4.816-.751-2.467-1.275-4.673-1.275-4.646 1.275-4.646 1.275Z"
              clipRule="evenodd"
            />
            <path
              fill="#FFD83D"
              stroke="#000"
              strokeWidth={0.5}
              d="m8.48 8.742-.21.137.074.113h9.678l.059-.166-.236-.084.236.084v-.003l.003-.005.006-.02a3.383 3.383 0 0 0 .093-.331c.05-.216.107-.516.122-.85.03-.656-.093-1.506-.798-2.05-.705-.545-1.595-.463-2.38-.288-.268.06-.54.134-.795.204l-.352.095c-.361.094-.67.158-.922.158-.25 0-.524-.06-.836-.147a21.207 21.207 0 0 1-.303-.088c-.224-.066-.465-.138-.707-.194-.732-.172-1.571-.236-2.504.234-.484.244-.768.586-.904.971-.133.378-.116.772-.045 1.117.07.345.198.656.306.88a4.166 4.166 0 0 0 .186.34l.013.022.004.005.001.002v.001l.21-.137Z"
            />
            <path
              fill="#FFD83D"
              stroke="#000"
              strokeWidth={0.5}
              d="m7.503 9.127-.106-.226-.216.1.09.22 1.298 3.17.083.202.212-.056h.001l.004-.001.018-.005a8.415 8.415 0 0 1 .338-.08c.232-.053.564-.123.964-.193.8-.14 1.864-.28 2.93-.28 1.064 0 2.108.14 2.889.28a18.828 18.828 0 0 1 1.262.273l.017.004.004.001.212.059.085-.203 1.333-3.168.094-.221-.218-.102-.106.226.106-.226h-.001l-.002-.002-.005-.002-.02-.008a5.657 5.657 0 0 0-.342-.132 9.97 9.97 0 0 0-1.067-.303c-.947-.22-2.364-.436-4.263-.436s-3.316.217-4.263.436c-.473.11-.829.22-1.068.303a5.625 5.625 0 0 0-.342.132l-.019.008-.005.002-.002.001.105.227Zm5.48-2.862c.581 0 1.006-.517 1.006-1.095s-.425-1.095-1.006-1.095-1.006.517-1.006 1.095.425 1.095 1.006 1.095Z"
            />
            <mask
              id="liechtenstein_svg__e"
              width={4}
              height={5}
              x={11.132}
              y={1}
              ...
              maskUnits="userSpaceOnUse"
            >
              <path fill="#fff" d="M11.132 1h4v5h-4z" />
              <path
                fillRule="evenodd"
                d="M13.267 2H12.7l.073.923-.64-.078v.634l.65-.08-.083 1.454h.567l-.084-1.456.651.082v-.634l-.64.082.073-.927Z"
                clipRule="evenodd"
              />
            </mask>
            <path
    ...
    <defs>
      ...
      >
        ...
        <feBlend
          ...
          result="effect1_dropShadow_91_26744"
        />
        <feColorMatrix
          in="SourceAlpha"
          result="hardAlpha"
        ...
        <feBlend
          in2="effect1_dropShadow_91_26744"
          result="effect2_dropShadow_91_26744"
        />
        <feBlend
          in="SourceGraphic"
          in2="effect2_dropShadow_91_26744"
          result="shape"
        />
      </filter>
    </defs>
