...
const SvgMozambique = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#mozambique_svg__a)">
      <g clipPath="url(#mozambique_svg__b)">
        <mask
          id="mozambique_svg__c"
          width={36}
          height={24}
          x={3}
          y={2}
