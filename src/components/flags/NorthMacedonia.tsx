...
const SvgNorthMacedonia = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#north-macedonia_svg__a)">
      <g clipPath="url(#north-macedonia_svg__b)">
        <mask
          id="north-macedonia_svg__c"
          width={36}
          height={24}
          x={3}
          y={2}
        ...
        <g mask="url(#north-macedonia_svg__c)">
          <path
            fill="#F50100"
            fillRule="evenodd"
            d="M3 2v24h36V2H3Z"
          ...
          <g fill="#FFD018" mask="url(#north-macedonia_svg__d)">
            <path
              fillRule="evenodd"
