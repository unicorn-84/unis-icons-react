...
const SvgReunion = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#reunion_svg__a)">
      <g clipPath="url(#reunion_svg__b)">
        <mask
          id="reunion_svg__c"
          width={36}
          height={24}
        ...
        <g fillRule="evenodd" clipRule="evenodd" mask="url(#reunion_svg__c)">
