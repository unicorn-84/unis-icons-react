...
const SvgRussianFederation = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#russian-federation_svg__a)">
      <g clipPath="url(#russian-federation_svg__b)">
        <mask
          id="russian-federation_svg__c"
          width={36}
          height={24}
          x={3}
          y={2}
        ...
        <g mask="url(#russian-federation_svg__c)">
          <path
            fill="#3D58DB"
            fillRule="evenodd"
            d="M3 2v24h36V2H3Z"
          ...
          <g
            fillRule="evenodd"
            clipRule="evenodd"
            mask="url(#russian-federation_svg__d)"
          >
