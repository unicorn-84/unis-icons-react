...
const SvgSaba = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#saba_svg__a)">
      <g clipPath="url(#saba_svg__b)">
        <mask
          id="saba_svg__c"
          width={36}
          height={24}
        ...
        <g fillRule="evenodd" clipRule="evenodd" mask="url(#saba_svg__c)">
