...
const SvgUnitedStates = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g filter="url(#united-states_svg__a)">
      <g clipPath="url(#united-states_svg__b)">
        <mask
          id="united-states_svg__c"
          width={36}
          height={24}
          x={3}
          y={2}
        ...
        <g mask="url(#united-states_svg__c)">
          <path
            fill="#F7FCFF"
            fillRule="evenodd"
            d="M3 2h36v24H3V2Z"
    ...
    <defs>
      <clipPath id="united-states_svg__b">
      ...
      >
        ...
        <feBlend
          ...
          result="effect1_dropShadow_91_24277"
        />
        <feColorMatrix
          in="SourceAlpha"
          result="hardAlpha"
        ...
        <feBlend
          in2="effect1_dropShadow_91_24277"
          result="effect2_dropShadow_91_24277"
        />
        <feBlend
          in="SourceGraphic"
          in2="effect2_dropShadow_91_24277"
          result="shape"
        />
      </filter>
    </defs>
