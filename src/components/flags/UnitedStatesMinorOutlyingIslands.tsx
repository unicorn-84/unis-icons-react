...
const SvgUnitedStatesMinorOutlyingIslands = (
  ...
  <svg
    ...
    {...props}
  >
    <g filter="url(#united-states-minor-outlying-islands_svg__a)">
      <g clipPath="url(#united-states-minor-outlying-islands_svg__b)">
        <mask
          id="united-states-minor-outlying-islands_svg__c"
          width={36}
          height={24}
          x={3}
          y={2}
        ...
        <g mask="url(#united-states-minor-outlying-islands_svg__c)">
          <path
            fill="#F7FCFF"
            fillRule="evenodd"
            d="M3 2h36v24H3V2Z"
    ...
    <defs>
      <clipPath id="united-states-minor-outlying-islands_svg__b">
        <rect width={36} height={24} x={3} y={2} fill="#fff" rx={2} />
      </clipPath>
      <filter
        id="united-states-minor-outlying-islands_svg__a"
        width={42}
        height={30}
        x={0}
        y={0}
      ...
      >
        ...
        <feBlend
          ...
          result="effect1_dropShadow_91_24314"
        />
        <feColorMatrix
          in="SourceAlpha"
          result="hardAlpha"
        ...
        <feBlend
          in2="effect1_dropShadow_91_24314"
          result="effect2_dropShadow_91_24314"
        />
        <feBlend
          in="SourceGraphic"
          in2="effect2_dropShadow_91_24314"
          result="shape"
        />
      </filter>
    </defs>
...
export default SvgUnitedStatesMinorOutlyingIslands;
